...
public class cobraMonitor extends PApplet {
...
public void draw() {
  ...
  float x_axis = radians(PApplet.parseFloat(parsed_values[5]));
  float y_axis = radians(PApplet.parseFloat(parsed_values[6]));
  float z_axis = radians(PApplet.parseFloat(parsed_values[7]));
...
public String[] loadData(String values) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "cobraMonitor" };
    if (passedArgs != null) {
